...
class VzaarCurl
{
    ...
    public static function whoAmI()
    {
        ...
        $req = VzaarCurl::setAuth($_url);

        $c = new HttpRequest($_url);
        $c->verbose = VzaarCurl::$enableHttpVerbose;
    ...
    public static function getUserDetails($account)
    {
        ...
        $req->verbose = VzaarCurl::$enableHttpVerbose;
    ...
    public static function getVideoList($username, $auth = false, $count = 20, $labels = '', $status = '', $page = 1)
    {
        ...
        if ($auth) array_push($req->headers, VzaarCurl::setAuth($_url, 'GET')->to_header());
    ...
    {
        $signature = VzaarCurl::getUploadSignature();
...
die();
    ...
    public static function uploadSubtitle($language, $videoId, $body)
    {
        ...
        $req = VzaarCurl::setAuth($_url, 'POST');
    ...
    public static function getUploadSignature($redirectUrl = null, $multipart = false)
    {
        ...
        if (VzaarCurl::$enableFlashSupport) {
        ...
        $req = VzaarCurl::setAuth($_url, 'GET');
        $req->verbose = VzaarCurl::$enableHttpVerbose;
    ...
    {
file_put_contents("/kiwii/common/library/W3/Vzaar/vzaar_log.log", "\ntest editVideo", FILE_APPEND);

        $_url = self::$url . "api/videos/" . $id . ".xml";

        $req = VzaarCurl::setAuth($_url, 'PUT');
...
file_put_contents("/kiwii/common/library/W3/Vzaar/vzaar_log.log", "\ntest processVideo", FILE_APPEND);
        ...
        file_put_contents("/kiwii/common/library/W3/Vzaar/vzaar_log.log", $log_this);
    ...
    {
file_put_contents("/kiwii/common/library/W3/Vzaar/vzaar_log.log", "\ntest processVideoCustomized", FILE_APPEND);
